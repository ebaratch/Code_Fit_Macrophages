function y=Assumption121(param,temps,fixedParam)
...
function dy=G(t,X)
    ...
    dy(4)=monoInflux2*X(9)/WoundVol+monoInflux1*(X(7)+X(6))/(MacIni+MonoIni)+H-deltaMo*X(4)-Factor1*X(4)*X(9)/(WoundVol*(MacIni+MonoIni))-Infl1*X(4)*X(9)*(X(6)+X(7))/(WoundVol*(MacIni+MonoIni))+depol1*X(6)*X(8)/(MacIni);
    dy(5)=(d)*MonoIni-(HOC*OBini*X(5))*(Factor3+X(7)+X(6))/OBini/(1+M2InhOC*X(8))-Factor2*X(5)*X(9)/(WoundVol*(MacIni+MonoIni))-Infl2*X(5)*X(9)*(X(6)+X(7))/(WoundVol*(MacIni+MonoIni))+(depol2*X(7)*X(8)/(MacIni))-(AntiInfl*X(5)*(X(9))/(WoundVol))+(depol3*X(8))-(deltaM*X(5));
    ...
    dy(7)=Factor2*X(5)*X(9)/(WoundVol*(MacIni+MonoIni))+Infl2*X(5)*X(9)*(X(6)+X(7))/(WoundVol*(MacIni+MonoIni))-depol2*X(7)*X(8)/(MacIni)-deltaM*X(7)-(HOC*OBini*X(7))*(Factor3+X(7)+X(6))/OBini/(1+M2InhOC*X(8));
    dy(8)=AntiInfl*X(9)*(X(5))/(WoundVol)-deltaM*X(8)-depol3*X(8)-(HOC*OBini*X(8))*(Factor3+X(7)+X(6))/OBini/(1+M2InhOC*X(8));
