function y=Assumption221(param,temps,fixedParam)
...
HOC=(MonoIni+MacIni)*(1+OBInh*OBini)*deltaOC*OCini/(MacIni*Factor3);
d=(deltaM*MacIni+HOC*Factor3*MacIni/((1+OBInh*OBini)*(MacIni+MonoIni)))/MonoIni;
H=deltaMo*MonoIni;
...
function dy=G(t,X)
    ...
    dy(2)=HOC*Factor3*(X(5)+X(7)+X(8))/((MacIni+MonoIni)*(1+OBInh*X(1)))+HOC*(X(7)+X(6))*(X(5)+X(7)+X(8))/((MacIni+MonoIni)*(1+OBInh*X(1)))-deltaOC*(X(1))*X(2)/(OBini*(1+deltaTNF*(X(6)+X(7))));
    ...
    dy(5)=(d)*MonoIni-(HOC*X(5))*(Factor3+X(7)+X(6))/((MacIni+MonoIni)*(1+OBInh*X(1)))-(Infl2*X(5)*X(9)*(Factor2+X(6)+X(7))/(WoundVol*(MacIni+MonoIni)))+(depol2*X(7)*X(8)/(MacIni))-(AntiInfl*X(5)*(X(9))/(WoundVol))+(depol3*X(8))-(deltaM*X(5));
    dy(6)=Infl1*X(4)*X(9)*(Factor1+X(6)+X(7))/(WoundVol*(MacIni+MonoIni))-depol1*X(6)*X(8)/(MacIni)-deltaMo*X(6);
    dy(7)=Infl2*X(5)*X(9)*(Factor2+X(6)+X(7))/(WoundVol*(MacIni+MonoIni))-depol2*X(7)*X(8)/(MacIni)-deltaM*X(7)-(HOC*X(7))*(Factor3+X(7)+X(6))/((MacIni+MonoIni)*(1+OBInh*X(1)));
    dy(8)=AntiInfl*X(9)*(X(5))/(WoundVol)-deltaM*X(8)-depol3*X(8)-(HOC*X(8))*(Factor3+X(7)+X(6))/((MacIni+MonoIni)*(1+OBInh*X(1)));
