function y=Assumption311(param,temps,fixedParam)
...
function dy=G(t,X)
    ...
    dy(5)=(d)*MonoIni-(HOC*X(1)*X(5))/OBini/(1+M2Inh*X(8))-(Infl2*X(5)*X(9)*(Factor2+X(6)+X(7))/(WoundVol*(MacIni+MonoIni)))+(depol2*X(7)*X(8)/(MacIni))-(AntiInfl*X(5)*(X(9))/(WoundVol))+(depol3*X(8))-(deltaM*X(5));
    ...
    dy(8)=AntiInfl*X(9)*(X(5))/(WoundVol)-deltaM*X(8)-depol3*X(8)-(HOC*X(1)*X(8))/OBini/(1+M2Inh*X(8));
